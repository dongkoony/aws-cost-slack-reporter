...
def lambda_handler(event: Dict[str, Any], context: Any) -> Dict[str, Any]:
    ...
    try:
        ...
        logger.info(f"비용 데이터 조회 완료: 전일 ${daily_cost:.2f}, 이번달 누적 ${monthly_cost:.2f}")
        
        # 환율 조회 및 통화 변환
        from .exchange_rate import get_cost_in_both_currencies, get_current_exchange_rate_info
