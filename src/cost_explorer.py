...
def get_service_breakdown(start_date: str, end_date: str) -> Dict[str, float]:
    ...
    try:
        ...
        # 비용 순으로 정렬
        sorted_costs = dict(sorted(service_costs.items(), key=lambda x: x[1], reverse=True))
...
def get_cost_summary() -> Dict[str, Any]:
    ...
    try:
        ...
        logger.info(f"비용 요약 완료: 금일 ${daily_cost:.2f}, 이번달 누적 ${monthly_cost:.2f}")
        return summary
